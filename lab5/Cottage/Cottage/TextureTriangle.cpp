...
TextureTriangle::TextureTriangle(glm::vec3 vertex1, glm::vec3 vertex2, glm::vec3 vertex3)
	: m_vertex1(vertex1)
	, m_vertex2(vertex2)
	, m_vertex3(vertex3)
{
...
void TextureTriangle::Draw() const
{
...
void TextureTriangle::SetTexture(TextureHandle& texture)
{
	m_texture = texture;
}

void TextureTriangle::SetTextureScale(float scale)
{
