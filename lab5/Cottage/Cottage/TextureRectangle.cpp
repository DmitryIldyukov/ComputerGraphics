...
TextureRectangle::TextureRectangle(glm::vec3 position, glm::vec3 direction1, glm::vec3 direction2)
	:m_position(position)
...
void TextureRectangle::Draw() const
{
...
void TextureRectangle::SetTexture(TextureHandle& texture)
{
	m_texture = texture;
}

void TextureRectangle::SetTextureScale(float scale)
{
